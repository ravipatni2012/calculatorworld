...
<table align="center"  bgcolor="LightGrey" border="1" cellpadding="15px" bordercolor="black" >
	...
	<tr >
		<td  colspan="2" style="text-align:center">
			...
			<label for="age">Equated Monthly Installment (EMI) Calculator</label> 
	...
	<tr>
		...
		<td>
		<label for="dob">Principal Amount:</label>
		</td>
		
		<td>		
			<input type="text" name="txtamount" class="textbox" style='text-transform:uppercase' autofocus required>
		</td>
	...
	<tr>
		...
		<td>
		<label for="dob">Time Period (in number of months):</label>
		
		
		
		<td>
		
		<input type="range" min="1" max="12" step=".1" value="1" id="time" name="time" onchange='document.getElementById("timebar").value = "Time= " + document.getElementById("time").value;'/>
		<br>
		
		<input type="text" name="timebar" id="timebar" value="Time = 1" disabled />
		</td>
...
if (isset($_POST['btnsubmit']))
{
		...
		$calc=($amount*$rate *pow(1+$rate,$ti))/(pow(1+$rate,$ti)-1);

echo "<br>";	
	
echo " <b> <center>Principal Amount (INR)= " .$_POST["txtamount"] . "<br>"; 
echo "<br>";
echo " <b> <center>Rate of interest (in percentage)= " .$_POST["roibar"] . "<br>"; 
echo "<br>";
echo "<b> <center> EMI (INR)="  .$calc ;	
